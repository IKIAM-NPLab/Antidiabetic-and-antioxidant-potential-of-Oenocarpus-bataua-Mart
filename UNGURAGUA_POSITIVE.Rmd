...
init_log(log_file = "RESULTADOS/Results_1.txt")
```
...
```{r echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
EI_PCA_2<-plot_pca(compressed, color = "Subgroup")
EI_PCA_2
```
imputación de datos
...
# Save plot
ggsave('resultados/unguragua.png', width = 5, height = 4, device='png', dpi="print")
```
